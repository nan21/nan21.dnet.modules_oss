...
@NamedQueries({@NamedQuery(name = ProjectCategory.NQ_FIND_BY_NAME, query = "SELECT e FROM ProjectCategory e WHERE e.clientId = :pClientId and e.name = :pName", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE))})
@Entity
