...
public class IssueDsQueryBuilder extends QueryBuilderWithJpql<IssueDs,IssueDsFilter, IssueDsParam> {
	...
	public void setFilter(IssueDsFilter filter) {
 	...
 	public void beforeBuildWhere() {
 		if (this.params != null && this.params.getAffectedVersionId() != null) {
 			...
 			addCustomFilterItem("affectedVersionId",this.params.getAffectedVersionId());	
 		}	
 		if (this.params != null && this.params.getAffectedComponentId() != null) {
 			...
 			addCustomFilterItem("affectedComponentId",this.params.getAffectedComponentId());	
 		}	
 	}
}
