...
@Ds(entity=Issue.class,jpqlWhere="e.targetVersion.releaseDate is null", sort={@SortField(field=IssueRoadmapDs.fTARGETVERSIONDATE), @SortField(field=IssueRoadmapDs.fTARGETVERSION), @SortField(field=IssueRoadmapDs.fMODIFIEDAT,desc=true)})
