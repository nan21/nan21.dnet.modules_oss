...
public class ProjectVersionDsConv extends AbstractDsConverter<ProjectVersionDs, ProjectVersion> 
		implements IDsConverter<ProjectVersionDs, ProjectVersion> {
    
    @Override
    protected void modelToEntityReferences(ProjectVersionDs ds, ProjectVersion e, boolean isInsert) throws Exception {
    ...
    protected void lookup_project_Project(ProjectVersionDs ds, ProjectVersion e ) throws Exception {
