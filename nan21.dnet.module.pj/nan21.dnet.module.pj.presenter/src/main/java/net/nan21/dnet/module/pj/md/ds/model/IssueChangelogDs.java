...
@Ds(entity=Issue.class,jpqlWhere="e.fixedInVersion.id is not null", sort={@SortField(field=IssueChangelogDs.fFIXEDINVERSIONDATE,desc=true), @SortField(field=IssueChangelogDs.fFIXEDINVERSION), @SortField(field=IssueChangelogDs.fMODIFIEDAT,desc=true)})
