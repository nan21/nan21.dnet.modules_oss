...
public class ProjectComponentDsConv extends AbstractDsConverter<ProjectComponentDs, ProjectComponent> 
		implements IDsConverter<ProjectComponentDs, ProjectComponent> {
    
    @Override
    protected void modelToEntityReferences(ProjectComponentDs ds, ProjectComponent e, boolean isInsert) throws Exception {
    ...
    protected void lookup_project_Project(ProjectComponentDs ds, ProjectComponent e ) throws Exception {
