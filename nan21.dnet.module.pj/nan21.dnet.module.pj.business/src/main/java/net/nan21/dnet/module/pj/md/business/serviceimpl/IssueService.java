...
public class IssueService extends AbstractEntityService<Issue>
	...
	public List<Issue> findByProjectId(Long projectId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.project.id = :pProjectId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByStatusId(Long statusId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.status.id = :pStatusId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByTypeId(Long typeId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.type.id = :pTypeId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByPriorityId(Long priorityId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.priority.id = :pPriorityId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pPriorityId", priorityId)			 	
			.getResultList(); 
	}
	...
	public List<Issue> findByResolutionId(Long resolutionId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.resolution.id = :pResolutionId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pResolutionId", resolutionId)			 	
			.getResultList(); 
	}
	...
	public List<Issue> findBySeverityId(Long severityId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.severity.id = :pSeverityId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pSeverityId", severityId)			 	
			.getResultList(); 
	}
	...
	public List<Issue> findByReportedVersionId(Long reportedVersionId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.reportedVersion.id = :pReportedVersionId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByTargetVersionId(Long targetVersionId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.targetVersion.id = :pTargetVersionId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByFixedInVersionId(Long fixedInVersionId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.fixedInVersion.id = :pFixedInVersionId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByAssigneeId(Long assigneeId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.assignee.id = :pAssigneeId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByAssigneeRoleId(Long assigneeRoleId) {
		return (List<Issue>) this.em
			.createQuery("select e from Issue e where e.clientId = :pClientId and e.assigneeRole.id = :pAssigneeRoleId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Issue> findByAffectedVersionsId(Long affectedVersionsId) {
		return (List<Issue>) this.em
			.createQuery("select distinct e from Issue e, IN (e.affectedVersions) c where e.clientId = :pClientId and c.id = :pAffectedVersionsId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAffectedVersionsId", affectedVersionsId)			 	
			.getResultList(); 
	}
	
	public List<Issue> findByAffectedComponents(ProjectComponent affectedComponents) {
	...
	public List<Issue> findByAffectedComponentsId(Long affectedComponentsId) {
		return (List<Issue>) this.em
			.createQuery("select distinct e from Issue e, IN (e.affectedComponents) c where e.clientId = :pClientId and c.id = :pAffectedComponentsId", Issue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
