...
public class IssueTextService extends AbstractEntityService<IssueText>
	...
	public List<IssueText> findByIssueId(Long issueId) {
		return (List<IssueText>) this.em
			.createQuery("select e from IssueText e where e.clientId = :pClientId and e.issue.id = :pIssueId", IssueText.class)
	...
	public List<IssueText> findByIssueTextTypeId(Long issueTextTypeId) {
		return (List<IssueText>) this.em
			.createQuery("select e from IssueText e where e.clientId = :pClientId and e.issueTextType.id = :pIssueTextTypeId", IssueText.class)
			.setParameter("pClientId", Session.user.get().getClientId())
