...
public class AssetAcctService extends AbstractEntityService<AssetAcct>
	...
	public List<AssetAcct> findByAssetId(Long assetId) {
		return (List<AssetAcct>) this.em
			.createQuery("select e from AssetAcct e where e.clientId = :pClientId and e.asset.id = :pAssetId", AssetAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAssetId", assetId)			 	
			.getResultList(); 
	}
	...
	public List<AssetAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<AssetAcct>) this.em
			.createQuery("select e from AssetAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", AssetAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<AssetAcct> findByDeprecAccountId(Long deprecAccountId) {
		return (List<AssetAcct>) this.em
			.createQuery("select e from AssetAcct e where e.clientId = :pClientId and e.deprecAccount.id = :pDeprecAccountId", AssetAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AssetAcct> findByAcmlDeprecAccountId(Long acmlDeprecAccountId) {
		return (List<AssetAcct>) this.em
			.createQuery("select e from AssetAcct e where e.clientId = :pClientId and e.acmlDeprecAccount.id = :pAcmlDeprecAccountId", AssetAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
