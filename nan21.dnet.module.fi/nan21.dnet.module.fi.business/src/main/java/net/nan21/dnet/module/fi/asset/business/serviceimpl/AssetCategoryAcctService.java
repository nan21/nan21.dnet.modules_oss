...
public class AssetCategoryAcctService extends AbstractEntityService<AssetCategoryAcct>
		implements IAssetCategoryAcctService {
	...
	public AssetCategoryAcct findByAccount_schema( Long assetCategoryId, Long accSchemaId) {
		return (AssetCategoryAcct) this.em
			.createNamedQuery(AssetCategoryAcct.NQ_FIND_BY_ACCOUNT_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AssetCategoryAcct> findByAssetCategoryId(Long assetCategoryId) {
		return (List<AssetCategoryAcct>) this.em
			.createQuery("select e from AssetCategoryAcct e where e.clientId = :pClientId and e.assetCategory.id = :pAssetCategoryId", AssetCategoryAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAssetCategoryId", assetCategoryId)			 	
			.getResultList(); 
	}
	...
	public List<AssetCategoryAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<AssetCategoryAcct>) this.em
			.createQuery("select e from AssetCategoryAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", AssetCategoryAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<AssetCategoryAcct> findByDeprecAccountId(Long deprecAccountId) {
		return (List<AssetCategoryAcct>) this.em
			.createQuery("select e from AssetCategoryAcct e where e.clientId = :pClientId and e.deprecAccount.id = :pDeprecAccountId", AssetCategoryAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDeprecAccountId", deprecAccountId)			 	
			.getResultList(); 
	}
	
	public List<AssetCategoryAcct> findByAcmlDeprecAccount(Account acmlDeprecAccount) {
		return this.findByAcmlDeprecAccountId(acmlDeprecAccount.getId()); 
	}
	
	public List<AssetCategoryAcct> findByAcmlDeprecAccountId(Long acmlDeprecAccountId) {
		return (List<AssetCategoryAcct>) this.em
			.createQuery("select e from AssetCategoryAcct e where e.clientId = :pClientId and e.acmlDeprecAccount.id = :pAcmlDeprecAccountId", AssetCategoryAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
