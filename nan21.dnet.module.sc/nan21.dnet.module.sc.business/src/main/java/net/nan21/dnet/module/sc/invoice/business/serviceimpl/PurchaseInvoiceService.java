...
public class PurchaseInvoiceService extends AbstractEntityService<PurchaseInvoice>
	...
	public List<PurchaseInvoice> findByDocTypeId(Long docTypeId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.docType.id = :pDocTypeId", PurchaseInvoice.class)
	...
	public List<PurchaseInvoice> findBySupplierId(Long supplierId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.supplier.id = :pSupplierId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByCustomerId(Long customerId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.customer.id = :pCustomerId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByCurrencyId(Long currencyId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.currency.id = :pCurrencyId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByPaymentMethodId(Long paymentMethodId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.paymentMethod.id = :pPaymentMethodId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByPaymentTermId(Long paymentTermId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.paymentTerm.id = :pPaymentTermId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByFromAccountId(Long fromAccountId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.fromAccount.id = :pFromAccountId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pFromAccountId", fromAccountId)			 	
			.getResultList(); 
	}
	...
	public List<PurchaseInvoice> findByPurchaseOrderId(Long purchaseOrderId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select e from PurchaseInvoice e where e.clientId = :pClientId and e.purchaseOrder.id = :pPurchaseOrderId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByLinesId(Long linesId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select distinct e from PurchaseInvoice e, IN (e.lines) c where e.clientId = :pClientId and c.id = :pLinesId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoice> findByTaxesId(Long taxesId) {
		return (List<PurchaseInvoice>) this.em
			.createQuery("select distinct e from PurchaseInvoice e, IN (e.taxes) c where e.clientId = :pClientId and c.id = :pTaxesId", PurchaseInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public void doUnPost(PurchaseInvoice invoice) throws Exception {
		this.getBusinessDelegate(PurchaseInvoiceToAccDocBD.class).unPost(invoice);
	}
}
