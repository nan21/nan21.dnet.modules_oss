...
public class PurchaseOrderItemService extends AbstractEntityService<PurchaseOrderItem>
	...
	public List<PurchaseOrderItem> findByPurchaseOrderId(Long purchaseOrderId) {
		return (List<PurchaseOrderItem>) this.em
			.createQuery("select e from PurchaseOrderItem e where e.clientId = :pClientId and e.purchaseOrder.id = :pPurchaseOrderId", PurchaseOrderItem.class)
	...
	public List<PurchaseOrderItem> findByProductId(Long productId) {
		return (List<PurchaseOrderItem>) this.em
			.createQuery("select e from PurchaseOrderItem e where e.clientId = :pClientId and e.product.id = :pProductId", PurchaseOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseOrderItem> findByUomId(Long uomId) {
		return (List<PurchaseOrderItem>) this.em
			.createQuery("select e from PurchaseOrderItem e where e.clientId = :pClientId and e.uom.id = :pUomId", PurchaseOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseOrderItem> findByTaxId(Long taxId) {
		return (List<PurchaseOrderItem>) this.em
			.createQuery("select e from PurchaseOrderItem e where e.clientId = :pClientId and e.tax.id = :pTaxId", PurchaseOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pTaxId", taxId)			 	
			.getResultList(); 
	}
	
	public List<PurchaseOrderItem> findByItemTaxes(PurchaseOrderItemTax itemTaxes) {
		return this.findByItemTaxesId(itemTaxes.getId()); 
	}
	
	public List<PurchaseOrderItem> findByItemTaxesId(Long itemTaxesId) {
		return (List<PurchaseOrderItem>) this.em
			.createQuery("select distinct e from PurchaseOrderItem e, IN (e.itemTaxes) c where e.clientId = :pClientId and c.id = :pItemTaxesId", PurchaseOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
