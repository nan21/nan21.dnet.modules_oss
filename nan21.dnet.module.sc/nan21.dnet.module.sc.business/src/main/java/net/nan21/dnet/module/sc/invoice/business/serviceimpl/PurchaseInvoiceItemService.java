...
public class PurchaseInvoiceItemService extends AbstractEntityService<PurchaseInvoiceItem>
		{
	...
	public List<PurchaseInvoiceItem> findByPurchaseInvoice(PurchaseInvoice purchaseInvoice) {
		return this.findByPurchaseInvoiceId(purchaseInvoice.getId()); 
	}
	
	public List<PurchaseInvoiceItem> findByPurchaseInvoiceId(Long purchaseInvoiceId) {
		return (List<PurchaseInvoiceItem>) this.em
			.createQuery("select e from PurchaseInvoiceItem e where e.clientId = :pClientId and e.purchaseInvoice.id = :pPurchaseInvoiceId", PurchaseInvoiceItem.class)
	...
	public List<PurchaseInvoiceItem> findByProductId(Long productId) {
		return (List<PurchaseInvoiceItem>) this.em
			.createQuery("select e from PurchaseInvoiceItem e where e.clientId = :pClientId and e.product.id = :pProductId", PurchaseInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoiceItem> findByUomId(Long uomId) {
		return (List<PurchaseInvoiceItem>) this.em
			.createQuery("select e from PurchaseInvoiceItem e where e.clientId = :pClientId and e.uom.id = :pUomId", PurchaseInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PurchaseInvoiceItem> findByTaxId(Long taxId) {
		return (List<PurchaseInvoiceItem>) this.em
			.createQuery("select e from PurchaseInvoiceItem e where e.clientId = :pClientId and e.tax.id = :pTaxId", PurchaseInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pTaxId", taxId)			 	
			.getResultList(); 
	}
	
	public List<PurchaseInvoiceItem> findByItemTaxes(PurchaseInvoiceItemTax itemTaxes) {
		return this.findByItemTaxesId(itemTaxes.getId()); 
	}
	
	public List<PurchaseInvoiceItem> findByItemTaxesId(Long itemTaxesId) {
		return (List<PurchaseInvoiceItem>) this.em
			.createQuery("select distinct e from PurchaseInvoiceItem e, IN (e.itemTaxes) c where e.clientId = :pClientId and c.id = :pItemTaxesId", PurchaseInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pItemTaxesId", itemTaxesId)			 	
			.getResultList(); 
	}
}
