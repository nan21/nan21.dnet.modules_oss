...
public class PurchaseInvoiceItemTaxService extends AbstractEntityService<PurchaseInvoiceItemTax>
		implements IPurchaseInvoiceItemTaxService {
	...
	public List<PurchaseInvoiceItemTax> findByPurchaseInvoiceItemId(Long purchaseInvoiceItemId) {
		return (List<PurchaseInvoiceItemTax>) this.em
			.createQuery("select e from PurchaseInvoiceItemTax e where e.clientId = :pClientId and e.purchaseInvoiceItem.id = :pPurchaseInvoiceItemId", PurchaseInvoiceItemTax.class)
	...
	public List<PurchaseInvoiceItemTax> findByTaxId(Long taxId) {
		return (List<PurchaseInvoiceItemTax>) this.em
			.createQuery("select e from PurchaseInvoiceItemTax e where e.clientId = :pClientId and e.tax.id = :pTaxId", PurchaseInvoiceItemTax.class)
			.setParameter("pClientId", Session.user.get().getClientId())
