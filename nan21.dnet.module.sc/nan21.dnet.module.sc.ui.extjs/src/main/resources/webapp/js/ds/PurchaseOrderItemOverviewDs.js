...
Ext.define("net.nan21.dnet.module.sc.order.ds.model.PurchaseOrderItemOverviewDs", {
...
Dnet.createFilterModelFromRecordModel({
	recordModelFqn: "net.nan21.dnet.module.sc.order.ds.model.PurchaseOrderItemOverviewDs",
	fields: [
