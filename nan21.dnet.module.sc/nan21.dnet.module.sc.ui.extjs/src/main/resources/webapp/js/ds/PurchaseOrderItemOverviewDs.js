...
Ext.define("net.nan21.dnet.module.sc.order.ds.model.PurchaseOrderItemOverviewDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [
...
Ext.define("net.nan21.dnet.module.sc.order.ds.param.PurchaseOrderItemOverviewDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
});
