 ...
 */
Ext.define("net.nan21.dnet.module.sc.invoice.dc.PurchaseTxAmountOverview", {
	extend: "dnet.core.dc.AbstractDc",

	recordModel: "net.nan21.dnet.module.sc.invoice.ds.model.PurchaseTxAmountOverviewDs",
	filterModel: "net.nan21.dnet.module.sc.invoice.ds.model.PurchaseTxAmountOverviewDsFilter",
	paramModel: "net.nan21.dnet.module.sc.invoice.ds.param.PurchaseTxAmountOverviewDsParam",
...
Ext.define("net.nan21.dnet.module.sc.invoice.dc.PurchaseTxAmountOverview$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
	alias: "widget.sc_invoice_dc_PurchaseTxAmountOverview$Filter",
...
Ext.define("net.nan21.dnet.module.sc.invoice.dc.PurchaseTxAmountOverview$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias: "widget.sc_invoice_dc_PurchaseTxAmountOverview$List",
	_noImport_: true,

	_defineColumns_: function() {
		this._getBuilder_()
			.addTextColumn({ name:"customer", dataIndex:"customer", width:80})
