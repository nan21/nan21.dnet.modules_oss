 ...
 */
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseOrderItemOverview", {
...
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseOrderItemOverview$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
	alias: "widget.sc_order_dc_PurchaseOrderItemOverview$Filter",
	...
	_defineElements_: function() {
		this._getBuilder_()
			...
			.addLov({xtype:"bd_org_lovs_LegalEntityOrganizations", name:"customer", dataIndex:"customerName", anchor:"-20",
				retFieldMapping: [
					{lovField:"id", dsField: "customerId"} 
				]})
			.addLov({xtype:"md_bp_lovs_BusinessPartnersName", name:"supplier", dataIndex:"supplierName", anchor:"-20",
				retFieldMapping: [
...
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseOrderItemOverview$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias: "widget.sc_order_dc_PurchaseOrderItemOverview$List",
	_noImport_: true,
...
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseOrderItemOverview$DocView", {
	extend: "dnet.core.dc.AbstractDcvEditForm",
	alias: "widget.sc_order_dc_PurchaseOrderItemOverview$DocView",
