...
/** Data-provider for a standalone payables overview */
@Ds(entity = PurchaseTxAmount.class)
public class PurchaseTxAmountOverviewDs
		extends
	...
	public PurchaseTxAmountOverviewDs() {
		super();
	}

	public PurchaseTxAmountOverviewDs(PurchaseTxAmount e) {
		super(e);
	}
