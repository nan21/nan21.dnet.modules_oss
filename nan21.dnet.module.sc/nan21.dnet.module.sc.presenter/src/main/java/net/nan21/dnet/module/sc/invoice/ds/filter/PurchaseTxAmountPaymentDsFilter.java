...
public class PurchaseTxAmountPaymentDsFilter extends AbstractAuditableDsFilter {
	...
	private Date paymentDocDate_From;

	private Date paymentDocDate_To;
	...
	public Date getPaymentDocDate_From() {
		return this.paymentDocDate_From;
	}

	public Date getPaymentDocDate_To() {
		return this.paymentDocDate_To;
	}
	...
	public void setPaymentDocDate_From(Date paymentDocDate_From) {
		this.paymentDocDate_From = paymentDocDate_From;
	}

	public void setPaymentDocDate_To(Date paymentDocDate_To) {
		this.paymentDocDate_To = paymentDocDate_To;
	}
