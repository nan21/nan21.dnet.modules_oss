...
import net.nan21.dnet.module.sc.invoice.ds.model.PurchaseInvoiceItemOverviewDs;

/**
 * Helper filter object to run query by example with range values.
 *
 */
public class PurchaseInvoiceItemOverviewDsFilter
		extends
			PurchaseInvoiceItemOverviewDs {
