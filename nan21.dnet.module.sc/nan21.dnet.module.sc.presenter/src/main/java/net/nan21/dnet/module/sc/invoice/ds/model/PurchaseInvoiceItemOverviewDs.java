...
public class PurchaseInvoiceItemOverviewDs extends AbstractAuditableDs<PurchaseInvoiceItem> {
 	...
 	@DsField(join="left", path="purchaseInvoice.code")
 	...
 	@DsField(join="left", path="purchaseInvoice.customer.id")
 	private Long customerId;
 	
 	@DsField(join="left", path="purchaseInvoice.customer.code")
 	private String customerCode;
 	
 	@DsField(join="left", path="purchaseInvoice.customer.name")
 	private String customerName;
 	
 	@DsField(join="left", path="purchaseInvoice.supplier.id")
 	private Long supplierId;
 	
 	@DsField(join="left", path="purchaseInvoice.supplier.code")
 	private String supplierCode;
 	
 	@DsField(join="left", path="purchaseInvoice.supplier.name")
 	private String supplierName;
 	
 	@DsField(join="left", path="purchaseInvoice.docType.id")
 	private Long docTypeId;
 	
 	@DsField(join="left", path="purchaseInvoice.docType.name")
 	private String docType;
 	
 	@DsField(join="left", path="purchaseInvoice.currency.id")
 	private Long currencyId;
 	
 	@DsField(join="left", path="purchaseInvoice.currency.code")
 	private String currency;
 	
 	@DsField(join="left", path="purchaseInvoice.confirmed")
 	private Boolean confirmed;
 	
 	@DsField(join="left", path="purchaseInvoice.posted")
	...
	public PurchaseInvoiceItemOverviewDs() {
		super();
	}

 	public PurchaseInvoiceItemOverviewDs(PurchaseInvoiceItem e) {
		super(e);
	}
