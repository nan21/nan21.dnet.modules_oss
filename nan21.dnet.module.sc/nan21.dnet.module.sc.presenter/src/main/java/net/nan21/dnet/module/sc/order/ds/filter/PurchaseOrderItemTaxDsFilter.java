...
public class PurchaseOrderItemTaxDsFilter extends AbstractAuditableDsFilter {

	private Long purchaseOrderItemId;

	private Long purchaseOrderItemId_From;

	private Long purchaseOrderItemId_To;
	...
	public Long getPurchaseOrderItemId_From() {
		return this.purchaseOrderItemId_From;
	}

	public Long getPurchaseOrderItemId_To() {
		return this.purchaseOrderItemId_To;
	}
	...
	public void setPurchaseOrderItemId_From(Long purchaseOrderItemId_From) {
		this.purchaseOrderItemId_From = purchaseOrderItemId_From;
	}

	public void setPurchaseOrderItemId_To(Long purchaseOrderItemId_To) {
		this.purchaseOrderItemId_To = purchaseOrderItemId_To;
	}
