...
Dnet.createFilterModelFromRecordModel({
	recordModelFqn: "net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountPaymentProposalDs",
	fields: [
...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountPaymentProposalDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
