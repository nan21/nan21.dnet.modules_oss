...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountOverviewDs", {
...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountOverviewDsFilter", {
	extend: 'Ext.data.Model',
	fields: [
		{name:"createdAt", type:"date", dateFormat:Dnet.MODEL_DATE_FORMAT},
...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.param.SalesTxAmountOverviewDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
