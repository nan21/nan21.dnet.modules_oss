...
Dnet.createFilterModelFromRecordModel({
	recordModelFqn: "net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountOverviewDs",
	fields: [
...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.model.SalesTxAmountOverviewDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
