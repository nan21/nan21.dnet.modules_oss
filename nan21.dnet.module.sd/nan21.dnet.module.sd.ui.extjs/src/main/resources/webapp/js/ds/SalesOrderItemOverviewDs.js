...
Ext.define("net.nan21.dnet.module.sd.order.ds.model.SalesOrderItemOverviewDs", {
...
Dnet.createFilterModelFromRecordModel({
	recordModelFqn: "net.nan21.dnet.module.sd.order.ds.model.SalesOrderItemOverviewDs",
	fields: [
