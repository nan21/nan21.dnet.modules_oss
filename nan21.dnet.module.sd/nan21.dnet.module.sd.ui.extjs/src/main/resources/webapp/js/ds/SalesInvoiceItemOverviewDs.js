...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.model.SalesInvoiceItemOverviewDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [
...
Ext.define("net.nan21.dnet.module.sd.invoice.ds.param.SalesInvoiceItemOverviewDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
});
