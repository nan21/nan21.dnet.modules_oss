...
public class OpportunityService extends AbstractEntityService<Opportunity>
	...
	public List<Opportunity> findByAccountId(Long accountId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.account.id = :pAccountId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccountId", accountId)			 	
			.getResultList(); 
	}
	...
	public List<Opportunity> findByExpectedCurrencyId(Long expectedCurrencyId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.expectedCurrency.id = :pExpectedCurrencyId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Opportunity> findBySalesStageId(Long salesStageId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.salesStage.id = :pSalesStageId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pSalesStageId", salesStageId)			 	
			.getResultList(); 
	}
	...
	public List<Opportunity> findByStatusId(Long statusId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.status.id = :pStatusId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Opportunity> findByPriorityId(Long priorityId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.priority.id = :pPriorityId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Opportunity> findByLeadSourceId(Long leadSourceId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.leadSource.id = :pLeadSourceId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pLeadSourceId", leadSourceId)			 	
			.getResultList(); 
	}
	
	public List<Opportunity> findByResultReason(OpportunityResultReason resultReason) {
		return this.findByResultReasonId(resultReason.getId()); 
	}
	
	public List<Opportunity> findByResultReasonId(Long resultReasonId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.resultReason.id = :pResultReasonId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Opportunity> findByAssignedToId(Long assignedToId) {
		return (List<Opportunity>) this.em
			.createQuery("select e from Opportunity e where e.clientId = :pClientId and e.assignedTo.id = :pAssignedToId", Opportunity.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAssignedToId", assignedToId)			 	
			.getResultList(); 
	}
}
