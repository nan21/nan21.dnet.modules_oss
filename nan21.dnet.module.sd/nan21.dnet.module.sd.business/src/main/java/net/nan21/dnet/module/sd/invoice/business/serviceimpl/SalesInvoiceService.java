...
public class SalesInvoiceService extends AbstractEntityService<SalesInvoice>
	...
	public List<SalesInvoice> findByPriceListId(Long priceListId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.priceList.id = :pPriceListId", SalesInvoice.class)
	...
	public List<SalesInvoice> findByCurrencyId(Long currencyId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.currency.id = :pCurrencyId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByPaymentMethodId(Long paymentMethodId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.paymentMethod.id = :pPaymentMethodId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByPaymentTermId(Long paymentTermId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.paymentTerm.id = :pPaymentTermId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByDocTypeId(Long docTypeId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.docType.id = :pDocTypeId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByCustomerId(Long customerId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.customer.id = :pCustomerId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByBillToLocationId(Long billToLocationId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.billToLocation.id = :pBillToLocationId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByBillToContactId(Long billToContactId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.billToContact.id = :pBillToContactId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findBySupplierId(Long supplierId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.supplier.id = :pSupplierId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findBySalesOrderId(Long salesOrderId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select e from SalesInvoice e where e.clientId = :pClientId and e.salesOrder.id = :pSalesOrderId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByLinesId(Long linesId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select distinct e from SalesInvoice e, IN (e.lines) c where e.clientId = :pClientId and c.id = :pLinesId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoice> findByTaxesId(Long taxesId) {
		return (List<SalesInvoice>) this.em
			.createQuery("select distinct e from SalesInvoice e, IN (e.taxes) c where e.clientId = :pClientId and c.id = :pTaxesId", SalesInvoice.class)
			.setParameter("pClientId", Session.user.get().getClientId())
