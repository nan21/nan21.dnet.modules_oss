...
public class SalesInvoiceItemService extends AbstractEntityService<SalesInvoiceItem>
	...
	public List<SalesInvoiceItem> findBySalesInvoiceId(Long salesInvoiceId) {
		return (List<SalesInvoiceItem>) this.em
			.createQuery("select e from SalesInvoiceItem e where e.clientId = :pClientId and e.salesInvoice.id = :pSalesInvoiceId", SalesInvoiceItem.class)
	...
	public List<SalesInvoiceItem> findByProductId(Long productId) {
		return (List<SalesInvoiceItem>) this.em
			.createQuery("select e from SalesInvoiceItem e where e.clientId = :pClientId and e.product.id = :pProductId", SalesInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoiceItem> findByUomId(Long uomId) {
		return (List<SalesInvoiceItem>) this.em
			.createQuery("select e from SalesInvoiceItem e where e.clientId = :pClientId and e.uom.id = :pUomId", SalesInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoiceItem> findByTaxId(Long taxId) {
		return (List<SalesInvoiceItem>) this.em
			.createQuery("select e from SalesInvoiceItem e where e.clientId = :pClientId and e.tax.id = :pTaxId", SalesInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesInvoiceItem> findByItemTaxesId(Long itemTaxesId) {
		return (List<SalesInvoiceItem>) this.em
			.createQuery("select distinct e from SalesInvoiceItem e, IN (e.itemTaxes) c where e.clientId = :pClientId and c.id = :pItemTaxesId", SalesInvoiceItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
