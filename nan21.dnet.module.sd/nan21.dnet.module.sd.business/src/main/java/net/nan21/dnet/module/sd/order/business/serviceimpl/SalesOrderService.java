...
public class SalesOrderService extends AbstractEntityService<SalesOrder>
	...
	public List<SalesOrder> findByDocTypeId(Long docTypeId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.docType.id = :pDocTypeId", SalesOrder.class)
	...
	public List<SalesOrder> findByCustomerId(Long customerId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.customer.id = :pCustomerId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findBySupplierId(Long supplierId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.supplier.id = :pSupplierId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByPriceListId(Long priceListId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.priceList.id = :pPriceListId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByCurrencyId(Long currencyId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.currency.id = :pCurrencyId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByPaymentMethodId(Long paymentMethodId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.paymentMethod.id = :pPaymentMethodId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByPaymentTermId(Long paymentTermId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.paymentTerm.id = :pPaymentTermId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByInventoryId(Long inventoryId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.inventory.id = :pInventoryId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByDeliveryMethodId(Long deliveryMethodId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.deliveryMethod.id = :pDeliveryMethodId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByCarrierId(Long carrierId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.carrier.id = :pCarrierId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCarrierId", carrierId)			 	
			.getResultList(); 
	}
	...
	public List<SalesOrder> findByBillToId(Long billToId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.billTo.id = :pBillToId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pBillToId", billToId)			 	
			.getResultList(); 
	}
	...
	public List<SalesOrder> findByBillToLocationId(Long billToLocationId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.billToLocation.id = :pBillToLocationId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByBillToContactId(Long billToContactId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.billToContact.id = :pBillToContactId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByShipToId(Long shipToId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.shipTo.id = :pShipToId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pShipToId", shipToId)			 	
			.getResultList(); 
	}
	...
	public List<SalesOrder> findByShipToLocationId(Long shipToLocationId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.shipToLocation.id = :pShipToLocationId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByShipToContactId(Long shipToContactId) {
		return (List<SalesOrder>) this.em
			.createQuery("select e from SalesOrder e where e.clientId = :pClientId and e.shipToContact.id = :pShipToContactId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByLinesId(Long linesId) {
		return (List<SalesOrder>) this.em
			.createQuery("select distinct e from SalesOrder e, IN (e.lines) c where e.clientId = :pClientId and c.id = :pLinesId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrder> findByTaxesId(Long taxesId) {
		return (List<SalesOrder>) this.em
			.createQuery("select distinct e from SalesOrder e, IN (e.taxes) c where e.clientId = :pClientId and c.id = :pTaxesId", SalesOrder.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pTaxesId", taxesId)			 	
			.getResultList(); 
	}
	
	public void doGenerateInvoice(SalesOrder salesOrder, TxDocType invDocType) throws Exception {
		this.getBusinessDelegate(SalesOrderToInvoiceBD.class).generateInvoice(salesOrder, invDocType);
	}
	
	public void doGenerateDelivery(SalesOrder salesOrder, TxDocType deliveryDocType, InvTransactionType delivTxType, Date delivEventDate ) throws Exception {
