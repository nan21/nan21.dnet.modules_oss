...
public class SalesInvoiceTaxService extends AbstractEntityService<SalesInvoiceTax>
		implements ISalesInvoiceTaxService {
	...
	public List<SalesInvoiceTax> findBySalesInvoiceId(Long salesInvoiceId) {
		return (List<SalesInvoiceTax>) this.em
			.createQuery("select e from SalesInvoiceTax e where e.clientId = :pClientId and e.salesInvoice.id = :pSalesInvoiceId", SalesInvoiceTax.class)
	...
	public List<SalesInvoiceTax> findByTaxId(Long taxId) {
		return (List<SalesInvoiceTax>) this.em
			.createQuery("select e from SalesInvoiceTax e where e.clientId = :pClientId and e.tax.id = :pTaxId", SalesInvoiceTax.class)
			.setParameter("pClientId", Session.user.get().getClientId())
