...
public class SalesOrderItemService extends AbstractEntityService<SalesOrderItem>
	...
	public List<SalesOrderItem> findBySalesOrderId(Long salesOrderId) {
		return (List<SalesOrderItem>) this.em
			.createQuery("select e from SalesOrderItem e where e.clientId = :pClientId and e.salesOrder.id = :pSalesOrderId", SalesOrderItem.class)
	...
	public List<SalesOrderItem> findByProductId(Long productId) {
		return (List<SalesOrderItem>) this.em
			.createQuery("select e from SalesOrderItem e where e.clientId = :pClientId and e.product.id = :pProductId", SalesOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrderItem> findByUomId(Long uomId) {
		return (List<SalesOrderItem>) this.em
			.createQuery("select e from SalesOrderItem e where e.clientId = :pClientId and e.uom.id = :pUomId", SalesOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrderItem> findByTaxId(Long taxId) {
		return (List<SalesOrderItem>) this.em
			.createQuery("select e from SalesOrderItem e where e.clientId = :pClientId and e.tax.id = :pTaxId", SalesOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<SalesOrderItem> findByItemTaxesId(Long itemTaxesId) {
		return (List<SalesOrderItem>) this.em
			.createQuery("select distinct e from SalesOrderItem e, IN (e.itemTaxes) c where e.clientId = :pClientId and c.id = :pItemTaxesId", SalesOrderItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
