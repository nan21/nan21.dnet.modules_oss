...
public class SalesOrderItemOverviewDs extends AbstractAuditableDs<SalesOrderItem> {
 	...
 	@DsField(join="left", path="salesOrder.docDate")
 	private Date docDate;
 	
 	@DsField(join="left", path="salesOrder.customer.id")
 	private Long customerId;
 	
 	@DsField(join="left", path="salesOrder.customer.code")
 	private String customerCode;
 	
 	@DsField(join="left", path="salesOrder.customer.name")
 	private String customerName;
 	
 	@DsField(join="left", path="salesOrder.supplier.id")
 	private Long supplierId;
 	
 	@DsField(join="left", path="salesOrder.supplier.code")
 	private String supplierCode;
 	
 	@DsField(join="left", path="salesOrder.supplier.name")
 	private String supplierName;
 	
 	@DsField(join="left", path="salesOrder.docType.id")
 	private Long docTypeId;
 	
 	@DsField(join="left", path="salesOrder.docType.name")
 	private String docType;
 	
 	@DsField(join="left", path="salesOrder.currency.id")
 	private Long currencyId;
 	
 	@DsField(join="left", path="salesOrder.currency.code")
 	private String currency;
 	
 	@DsField(join="left", path="salesOrder.confirmed")
	...
	public SalesOrderItemOverviewDs() {
		super();
	}

 	public SalesOrderItemOverviewDs(SalesOrderItem e) {
		super(e);
	}
