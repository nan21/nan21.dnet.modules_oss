...
public class PaymentInAmountDsConv extends AbstractDsConverter<PaymentInAmountDs, PaymentInAmount> 
		implements IDsConverter<PaymentInAmountDs, PaymentInAmount> {
    
    @Override
    protected void modelToEntityReferences(PaymentInAmountDs ds, PaymentInAmount e, boolean isInsert) throws Exception {
