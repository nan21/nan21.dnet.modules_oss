...
@RefLookups({
		@RefLookup(refId = SalesOrderItemDs.f_salesOrderId),
		@RefLookup(refId = SalesOrderItemDs.f_uomId),
		@RefLookup(refId = SalesOrderItemDs.f_productId, namedQuery = Product.NQ_FIND_BY_CODE, params = {@Param(name = "pCode", field = SalesOrderItemDs.f_productCode)}),
		@RefLookup(refId = SalesOrderItemDs.f_taxId, namedQuery = Tax.NQ_FIND_BY_NAME, params = {@Param(name = "pName", field = SalesOrderItemDs.f_tax)})})
