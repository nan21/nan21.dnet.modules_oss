...
public class ActDetailHistoryService extends AbstractEntityService<ActDetailHistory>
		implements IActDetailHistoryService {
	...
	public List<ActDetailHistory> findByByteArrayId(String byteArrayId) {
		return (List<ActDetailHistory>) this.em
			.createQuery("select e from ActDetailHistory e where  e.byteArray.id = :pByteArrayId", ActDetailHistory.class)
					.setParameter("pByteArrayId", byteArrayId)			 	
			.getResultList(); 
	}
}
