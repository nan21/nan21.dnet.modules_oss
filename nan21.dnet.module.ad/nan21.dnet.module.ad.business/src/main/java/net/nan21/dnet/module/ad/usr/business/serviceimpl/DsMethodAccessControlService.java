...
public class DsMethodAccessControlService extends AbstractEntityService<DsMethodAccessControl>
		implements IDsMethodAccessControlService {
	...
	public DsMethodAccessControl findByUnique(AccessControl accessControl,String dsName) {		 
	...
	public DsMethodAccessControl findByUnique( Long accessControlId,String dsName) {
		return (DsMethodAccessControl) this.em
			.createNamedQuery(DsMethodAccessControl.NQ_FIND_BY_UNIQUE_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<DsMethodAccessControl> findByAccessControl(AccessControl accessControl) {
		return this.findByAccessControlId(accessControl.getId()); 
	}
	
	public List<DsMethodAccessControl> findByAccessControlId(Long accessControlId) {
		return (List<DsMethodAccessControl>) this.em
			.createQuery("select e from DsMethodAccessControl e where e.clientId = :pClientId and e.accessControl.id = :pAccessControlId", DsMethodAccessControl.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccessControlId", accessControlId)			 	
			.getResultList(); 
	}
