...
public class ActTaskService extends AbstractEntityService<ActTask>
	...
	public List<ActTask> findByProcessDefinition(ActProcessDefinition processDefinition) {
	...
	public List<ActTask> findByProcessDefinitionId(String processDefinitionId) {
		return (List<ActTask>) this.em
			.createQuery("select e from ActTask e where  e.processDefinition.id = :pProcessDefinitionId", ActTask.class)
	...
	public List<ActTask> findByParentId(String parentId) {
		return (List<ActTask>) this.em
			.createQuery("select e from ActTask e where  e.parent.id = :pParentId", ActTask.class)
