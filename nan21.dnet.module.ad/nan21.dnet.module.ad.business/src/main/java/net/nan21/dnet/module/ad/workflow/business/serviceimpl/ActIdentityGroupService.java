...
public class ActIdentityGroupService extends AbstractEntityService<ActIdentityGroup>
		implements IActIdentityGroupService {
	...
	public List<ActIdentityGroup> findByUsersId(String usersId) {
		return (List<ActIdentityGroup>) this.em
			.createQuery("select distinct e from ActIdentityGroup e, IN (e.users) c where  c.id = :pUsersId", ActIdentityGroup.class)
