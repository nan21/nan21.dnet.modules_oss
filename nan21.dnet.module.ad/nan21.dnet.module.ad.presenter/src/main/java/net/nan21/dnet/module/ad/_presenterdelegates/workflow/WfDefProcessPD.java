...
public class WfDefProcessPD extends AbstractPresenterBaseService {

	public InputStream getDiagram(WfDefProcessDs ds) throws Exception {
		// KickstartService s = new
		// KickstartServiceImpl(this.getWorkflowEngine());
		...
		// rs.createProcessDefinitionQuery()
