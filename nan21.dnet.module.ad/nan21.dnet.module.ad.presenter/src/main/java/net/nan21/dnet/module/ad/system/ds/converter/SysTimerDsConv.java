...
public class SysTimerDsConv extends AbstractDsConverter<SysTimerDs, SysTimer> 
    ...
    @Override
    protected void modelToEntityReferences(SysTimerDs ds, SysTimer e, boolean isInsert) throws Exception {
    ...
    protected void lookup_jobCtx_SysJobCtx(SysTimerDs ds, SysTimer e ) throws Exception {
