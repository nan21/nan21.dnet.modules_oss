...
public class ActTaskInstanceDsQueryBuilder extends QueryBuilderWithJpql<ActTaskInstanceDs,ActTaskInstanceDsFilter, ActTaskInstanceDsParam> {
	...
	public void setFilter(ActTaskInstanceDsFilter filter) {
 	...
 	public void beforeBuildWhere() {
 		if (this.params.getHideActive() != null && this.params.getHideActive()==true) {
 			addFilterCondition("  e.endTime is not null ");
 		}
 		if (this.params.getHideCompleted()  != null && this.params.getHideCompleted()==true) {
