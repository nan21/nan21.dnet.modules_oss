...
@Ds(entity=DsMethodAccessControl.class, sort={@SortField(field=DsMethodAccessControlDs.fDSNAME), @SortField(field=DsMethodAccessControlDs.fSERVICEMETHOD)})
public class DsMethodAccessControlDs extends AbstractAuditableDs<DsMethodAccessControl> {
