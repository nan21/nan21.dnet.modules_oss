...
public class CsvExportFieldDsConv extends AbstractDsConverter<CsvExportFieldDs, CsvExportField> 
		implements IDsConverter<CsvExportFieldDs, CsvExportField> {
    
    @Override
    protected void modelToEntityReferences(CsvExportFieldDs ds, CsvExportField e, boolean isInsert) throws Exception {
    ...
    protected void lookup_csvExport_CsvExport(CsvExportFieldDs ds, CsvExportField e ) throws Exception {
