...
public class TaxAcctService extends AbstractEntityService<TaxAcct>
	...
	public List<TaxAcct> findByTaxId(Long taxId) {
		return (List<TaxAcct>) this.em
			.createQuery("select e from TaxAcct e where e.clientId = :pClientId and e.tax.id = :pTaxId", TaxAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pTaxId", taxId)			 	
			.getResultList(); 
	}
	...
	public List<TaxAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<TaxAcct>) this.em
			.createQuery("select e from TaxAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", TaxAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<TaxAcct> findBySalesAccountId(Long salesAccountId) {
		return (List<TaxAcct>) this.em
			.createQuery("select e from TaxAcct e where e.clientId = :pClientId and e.salesAccount.id = :pSalesAccountId", TaxAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<TaxAcct> findByPurchaseAccountId(Long purchaseAccountId) {
		return (List<TaxAcct>) this.em
			.createQuery("select e from TaxAcct e where e.clientId = :pClientId and e.purchaseAccount.id = :pPurchaseAccountId", TaxAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<TaxAcct> findByNonDeductAccountId(Long nonDeductAccountId) {
		return (List<TaxAcct>) this.em
			.createQuery("select e from TaxAcct e where e.clientId = :pClientId and e.nonDeductAccount.id = :pNonDeductAccountId", TaxAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
