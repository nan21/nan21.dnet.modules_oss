...
public class BpAccountService extends AbstractEntityService<BpAccount>
	...
	public List<BpAccount> findByBpartnerId(Long bpartnerId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.bpartner.id = :pBpartnerId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pBpartnerId", bpartnerId)			 	
			.getResultList(); 
	}
	...
	public List<BpAccount> findByOrgId(Long orgId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.org.id = :pOrgId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pOrgId", orgId)			 	
			.getResultList(); 
	}
	...
	public List<BpAccount> findByCustGroupId(Long custGroupId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.custGroup.id = :pCustGroupId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCustGroupId", custGroupId)			 	
			.getResultList(); 
	}
	
	public List<BpAccount> findByCustPaymentMethod(PaymentMethod custPaymentMethod) {
	...
	public List<BpAccount> findByCustPaymentMethodId(Long custPaymentMethodId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.custPaymentMethod.id = :pCustPaymentMethodId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<BpAccount> findByCustPaymentTermId(Long custPaymentTermId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.custPaymentTerm.id = :pCustPaymentTermId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCustPaymentTermId", custPaymentTermId)			 	
			.getResultList(); 
	}
	
	public List<BpAccount> findByCustDeliveryMethod(DeliveryMethod custDeliveryMethod) {
	...
	public List<BpAccount> findByCustDeliveryMethodId(Long custDeliveryMethodId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.custDeliveryMethod.id = :pCustDeliveryMethodId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<BpAccount> findByVendGroupId(Long vendGroupId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.vendGroup.id = :pVendGroupId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pVendGroupId", vendGroupId)			 	
			.getResultList(); 
	}
	
	public List<BpAccount> findByVendPaymentMethod(PaymentMethod vendPaymentMethod) {
	...
	public List<BpAccount> findByVendPaymentMethodId(Long vendPaymentMethodId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.vendPaymentMethod.id = :pVendPaymentMethodId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<BpAccount> findByVendPaymentTermId(Long vendPaymentTermId) {
		return (List<BpAccount>) this.em
			.createQuery("select e from BpAccount e where e.clientId = :pClientId and e.vendPaymentTerm.id = :pVendPaymentTermId", BpAccount.class)
			.setParameter("pClientId", Session.user.get().getClientId())
