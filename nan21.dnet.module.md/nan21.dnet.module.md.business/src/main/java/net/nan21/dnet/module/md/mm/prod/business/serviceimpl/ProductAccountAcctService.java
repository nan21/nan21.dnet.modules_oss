...
public class ProductAccountAcctService extends AbstractEntityService<ProductAccountAcct>
		implements IProductAccountAcctService {
	...
	public ProductAccountAcct findByAccount_schema(ProductAccount prodAccount,AccSchema accSchema) {		 
	...
	public ProductAccountAcct findByAccount_schema( Long prodAccountId, Long accSchemaId) {
		return (ProductAccountAcct) this.em
			.createNamedQuery(ProductAccountAcct.NQ_FIND_BY_ACCOUNT_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<ProductAccountAcct> findByProdAccountId(Long prodAccountId) {
		return (List<ProductAccountAcct>) this.em
			.createQuery("select e from ProductAccountAcct e where e.clientId = :pClientId and e.prodAccount.id = :pProdAccountId", ProductAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pProdAccountId", prodAccountId)			 	
			.getResultList(); 
	}
	...
	public List<ProductAccountAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<ProductAccountAcct>) this.em
			.createQuery("select e from ProductAccountAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", ProductAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<ProductAccountAcct> findByExpenseAccountId(Long expenseAccountId) {
		return (List<ProductAccountAcct>) this.em
			.createQuery("select e from ProductAccountAcct e where e.clientId = :pClientId and e.expenseAccount.id = :pExpenseAccountId", ProductAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<ProductAccountAcct> findByRevenueAccountId(Long revenueAccountId) {
		return (List<ProductAccountAcct>) this.em
			.createQuery("select e from ProductAccountAcct e where e.clientId = :pClientId and e.revenueAccount.id = :pRevenueAccountId", ProductAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
