...
public class ProductService extends AbstractEntityService<Product>
	...
	public List<Product> findByDefaultUomId(Long defaultUomId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.defaultUom.id = :pDefaultUomId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDefaultUomId", defaultUomId)			 	
			.getResultList(); 
	}
	...
	public List<Product> findByWeightUomId(Long weightUomId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.weightUom.id = :pWeightUomId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pWeightUomId", weightUomId)			 	
			.getResultList(); 
	}
	...
	public List<Product> findByVolumeUomId(Long volumeUomId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.volumeUom.id = :pVolumeUomId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pVolumeUomId", volumeUomId)			 	
			.getResultList(); 
	}
	...
	public List<Product> findByDimUomId(Long dimUomId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.dimUom.id = :pDimUomId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDimUomId", dimUomId)			 	
			.getResultList(); 
	}
	...
	public List<Product> findByManufacturerId(Long manufacturerId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.manufacturer.id = :pManufacturerId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Product> findByAttributeSetId(Long attributeSetId) {
		return (List<Product>) this.em
			.createQuery("select e from Product e where e.clientId = :pClientId and e.attributeSet.id = :pAttributeSetId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Product> findByCategoriesId(Long categoriesId) {
		return (List<Product>) this.em
			.createQuery("select distinct e from Product e, IN (e.categories) c where e.clientId = :pClientId and c.id = :pCategoriesId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCategoriesId", categoriesId)			 	
			.getResultList(); 
	}
	
	public List<Product> findByAttributeValues(ProductAttributeValue attributeValues) {
	...
	public List<Product> findByAttributeValuesId(Long attributeValuesId) {
		return (List<Product>) this.em
			.createQuery("select distinct e from Product e, IN (e.attributeValues) c where e.clientId = :pClientId and c.id = :pAttributeValuesId", Product.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAttributeValuesId", attributeValuesId)			 	
			.getResultList(); 
	}
	
	public String getExpenseAcct(Product product, Organization organization, AccSchema schema) throws Exception {
		return this.getBusinessDelegate(ProductExpenseAcctBD.class).getPostingAcct(product, organization, schema);
	}
	
	public String getRevenueAcct(Product product, Organization organization, AccSchema schema) throws Exception {
		return this.getBusinessDelegate(ProductRevenueAcctBD.class).getPostingAcct(product, organization, schema);
	}
}
