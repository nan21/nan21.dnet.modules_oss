...
public class AccDocService extends AbstractEntityService<AccDoc>
	...
	public List<AccDoc> findByOrgId(Long orgId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.org.id = :pOrgId", AccDoc.class)
	...
	public List<AccDoc> findByAccSchemaId(Long accSchemaId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AccDoc> findByPeriodId(Long periodId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.period.id = :pPeriodId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AccDoc> findByJournalId(Long journalId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.journal.id = :pJournalId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AccDoc> findByBpartnerId(Long bpartnerId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.bpartner.id = :pBpartnerId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AccDoc> findByDocCurrencyId(Long docCurrencyId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.docCurrency.id = :pDocCurrencyId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDocCurrencyId", docCurrencyId)			 	
			.getResultList(); 
	}
	...
	public List<AccDoc> findByDocTypeId(Long docTypeId) {
		return (List<AccDoc>) this.em
			.createQuery("select e from AccDoc e where e.clientId = :pClientId and e.docType.id = :pDocTypeId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AccDoc> findByLinesId(Long linesId) {
		return (List<AccDoc>) this.em
			.createQuery("select distinct e from AccDoc e, IN (e.lines) c where e.clientId = :pClientId and c.id = :pLinesId", AccDoc.class)
			.setParameter("pClientId", Session.user.get().getClientId())
