...
public class AccItemAcctService extends AbstractEntityService<AccItemAcct>
	...
	public List<AccItemAcct> findByAccItemId(Long accItemId) {
		return (List<AccItemAcct>) this.em
			.createQuery("select e from AccItemAcct e where e.clientId = :pClientId and e.accItem.id = :pAccItemId", AccItemAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccItemId", accItemId)			 	
			.getResultList(); 
	}
	...
	public List<AccItemAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<AccItemAcct>) this.em
			.createQuery("select e from AccItemAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", AccItemAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<AccItemAcct> findByCrAccountId(Long crAccountId) {
		return (List<AccItemAcct>) this.em
			.createQuery("select e from AccItemAcct e where e.clientId = :pClientId and e.crAccount.id = :pCrAccountId", AccItemAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCrAccountId", crAccountId)			 	
			.getResultList(); 
	}
	...
	public List<AccItemAcct> findByDbAccountId(Long dbAccountId) {
		return (List<AccItemAcct>) this.em
			.createQuery("select e from AccItemAcct e where e.clientId = :pClientId and e.dbAccount.id = :pDbAccountId", AccItemAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDbAccountId", dbAccountId)			 	
			.getResultList(); 
	}
}
