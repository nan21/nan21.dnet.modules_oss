...
public class PaymentService extends AbstractEntityService<Payment>
	...
	public List<Payment> findByCurrencyId(Long currencyId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.currency.id = :pCurrencyId", Payment.class)
	...
	public List<Payment> findByPaymentMethodId(Long paymentMethodId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.paymentMethod.id = :pPaymentMethodId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Payment> findByFromOrgId(Long fromOrgId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.fromOrg.id = :pFromOrgId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pFromOrgId", fromOrgId)			 	
			.getResultList(); 
	}
	...
	public List<Payment> findByToOrgId(Long toOrgId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.toOrg.id = :pToOrgId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pToOrgId", toOrgId)			 	
			.getResultList(); 
	}
	...
	public List<Payment> findByFromAccountId(Long fromAccountId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.fromAccount.id = :pFromAccountId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Payment> findByToAccountId(Long toAccountId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.toAccount.id = :pToAccountId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pToAccountId", toAccountId)			 	
			.getResultList(); 
	}
	...
	public List<Payment> findByBpartnerId(Long bpartnerId) {
		return (List<Payment>) this.em
			.createQuery("select e from Payment e where e.clientId = :pClientId and e.bpartner.id = :pBpartnerId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<Payment> findByLinesId(Long linesId) {
		return (List<Payment>) this.em
			.createQuery("select distinct e from Payment e, IN (e.lines) c where e.clientId = :pClientId and c.id = :pLinesId", Payment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
