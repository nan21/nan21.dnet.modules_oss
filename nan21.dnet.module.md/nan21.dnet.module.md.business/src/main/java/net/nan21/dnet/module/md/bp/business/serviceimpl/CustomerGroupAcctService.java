...
public class CustomerGroupAcctService extends AbstractEntityService<CustomerGroupAcct>
		implements ICustomerGroupAcctService {
	...
	public CustomerGroupAcct findByGroup_schema(CustomerGroup custGroup,AccSchema accSchema) {		 
	...
	public CustomerGroupAcct findByGroup_schema( Long custGroupId, Long accSchemaId) {
		return (CustomerGroupAcct) this.em
			.createNamedQuery(CustomerGroupAcct.NQ_FIND_BY_GROUP_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<CustomerGroupAcct> findByCustGroupId(Long custGroupId) {
		return (List<CustomerGroupAcct>) this.em
			.createQuery("select e from CustomerGroupAcct e where e.clientId = :pClientId and e.custGroup.id = :pCustGroupId", CustomerGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCustGroupId", custGroupId)			 	
			.getResultList(); 
	}
	...
	public List<CustomerGroupAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<CustomerGroupAcct>) this.em
			.createQuery("select e from CustomerGroupAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", CustomerGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<CustomerGroupAcct> findBySalesAccountId(Long salesAccountId) {
		return (List<CustomerGroupAcct>) this.em
			.createQuery("select e from CustomerGroupAcct e where e.clientId = :pClientId and e.salesAccount.id = :pSalesAccountId", CustomerGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<CustomerGroupAcct> findByPrepayAccountId(Long prepayAccountId) {
		return (List<CustomerGroupAcct>) this.em
			.createQuery("select e from CustomerGroupAcct e where e.clientId = :pClientId and e.prepayAccount.id = :pPrepayAccountId", CustomerGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
