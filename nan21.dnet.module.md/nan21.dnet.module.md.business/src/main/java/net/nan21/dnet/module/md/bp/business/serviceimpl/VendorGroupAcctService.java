...
public class VendorGroupAcctService extends AbstractEntityService<VendorGroupAcct>
		implements IVendorGroupAcctService {
	...
	public VendorGroupAcct findByGroup_schema( Long vendorGroupId, Long accSchemaId) {
		return (VendorGroupAcct) this.em
			.createNamedQuery(VendorGroupAcct.NQ_FIND_BY_GROUP_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<VendorGroupAcct> findByVendorGroupId(Long vendorGroupId) {
		return (List<VendorGroupAcct>) this.em
			.createQuery("select e from VendorGroupAcct e where e.clientId = :pClientId and e.vendorGroup.id = :pVendorGroupId", VendorGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pVendorGroupId", vendorGroupId)			 	
			.getResultList(); 
	}
	...
	public List<VendorGroupAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<VendorGroupAcct>) this.em
			.createQuery("select e from VendorGroupAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", VendorGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<VendorGroupAcct> findByPurchaseAccountId(Long purchaseAccountId) {
		return (List<VendorGroupAcct>) this.em
			.createQuery("select e from VendorGroupAcct e where e.clientId = :pClientId and e.purchaseAccount.id = :pPurchaseAccountId", VendorGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<VendorGroupAcct> findByPrepayAccountId(Long prepayAccountId) {
		return (List<VendorGroupAcct>) this.em
			.createQuery("select e from VendorGroupAcct e where e.clientId = :pClientId and e.prepayAccount.id = :pPrepayAccountId", VendorGroupAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
