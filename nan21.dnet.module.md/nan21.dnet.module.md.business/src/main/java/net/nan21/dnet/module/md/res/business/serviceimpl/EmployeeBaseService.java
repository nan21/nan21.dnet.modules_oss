...
public class EmployeeBaseService extends AbstractEntityService<EmployeeBase>
	...
	public List<EmployeeBase> findByEmployerId(Long employerId) {
		return (List<EmployeeBase>) this.em
			.createQuery("select e from EmployeeBase e where e.clientId = :pClientId and e.employer.id = :pEmployerId", EmployeeBase.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pEmployerId", employerId)			 	
			.getResultList(); 
	}
	...
	public List<EmployeeBase> findByCitizenshipId(Long citizenshipId) {
		return (List<EmployeeBase>) this.em
			.createQuery("select e from EmployeeBase e where e.clientId = :pClientId and e.citizenship.id = :pCitizenshipId", EmployeeBase.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCitizenshipId", citizenshipId)			 	
			.getResultList(); 
	}
}
