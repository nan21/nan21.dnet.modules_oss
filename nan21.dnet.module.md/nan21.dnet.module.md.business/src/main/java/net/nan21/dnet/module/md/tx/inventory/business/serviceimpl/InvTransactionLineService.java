...
public class InvTransactionLineService extends AbstractEntityService<InvTransactionLine>
		implements IInvTransactionLineService {
	...
	public List<InvTransactionLine> findByInvTransactionId(Long invTransactionId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.invTransaction.id = :pInvTransactionId", InvTransactionLine.class)
	...
	public List<InvTransactionLine> findByItemId(Long itemId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.item.id = :pItemId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pItemId", itemId)			 	
			.getResultList(); 
	}
	
	public List<InvTransactionLine> findByFromSubInventory(SubInventory fromSubInventory) {
		return this.findByFromSubInventoryId(fromSubInventory.getId()); 
	}
	
	public List<InvTransactionLine> findByFromSubInventoryId(Long fromSubInventoryId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.fromSubInventory.id = :pFromSubInventoryId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<InvTransactionLine> findByFromLocatorId(Long fromLocatorId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.fromLocator.id = :pFromLocatorId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pFromLocatorId", fromLocatorId)			 	
			.getResultList(); 
	}
	
	public List<InvTransactionLine> findByToSubInventory(SubInventory toSubInventory) {
	...
	public List<InvTransactionLine> findByToSubInventoryId(Long toSubInventoryId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.toSubInventory.id = :pToSubInventoryId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<InvTransactionLine> findByToLocatorId(Long toLocatorId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.toLocator.id = :pToLocatorId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pToLocatorId", toLocatorId)			 	
			.getResultList(); 
	}
	...
	public List<InvTransactionLine> findByUomId(Long uomId) {
		return (List<InvTransactionLine>) this.em
			.createQuery("select e from InvTransactionLine e where e.clientId = :pClientId and e.uom.id = :pUomId", InvTransactionLine.class)
			.setParameter("pClientId", Session.user.get().getClientId())
