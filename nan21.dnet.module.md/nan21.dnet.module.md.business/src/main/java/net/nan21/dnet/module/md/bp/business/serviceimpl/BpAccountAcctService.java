...
public class BpAccountAcctService extends AbstractEntityService<BpAccountAcct>
	...
	public BpAccountAcct findByAccount_schema( Long bpAccountId, Long accSchemaId) {
		return (BpAccountAcct) this.em
			.createNamedQuery(BpAccountAcct.NQ_FIND_BY_ACCOUNT_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<BpAccountAcct> findByBpAccountId(Long bpAccountId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.bpAccount.id = :pBpAccountId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pBpAccountId", bpAccountId)			 	
			.getResultList(); 
	}
	...
	public List<BpAccountAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	...
	public List<BpAccountAcct> findByCustSalesAccountId(Long custSalesAccountId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.custSalesAccount.id = :pCustSalesAccountId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<BpAccountAcct> findByCustPrepayAccountId(Long custPrepayAccountId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.custPrepayAccount.id = :pCustPrepayAccountId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pCustPrepayAccountId", custPrepayAccountId)			 	
			.getResultList(); 
	}
	
	public List<BpAccountAcct> findByVendorPurchaseAccount(Account vendorPurchaseAccount) {
		return this.findByVendorPurchaseAccountId(vendorPurchaseAccount.getId()); 
	}
	
	public List<BpAccountAcct> findByVendorPurchaseAccountId(Long vendorPurchaseAccountId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.vendorPurchaseAccount.id = :pVendorPurchaseAccountId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pVendorPurchaseAccountId", vendorPurchaseAccountId)			 	
			.getResultList(); 
	}
	
	public List<BpAccountAcct> findByVendorPrepayAccount(Account vendorPrepayAccount) {
		return this.findByVendorPrepayAccountId(vendorPrepayAccount.getId()); 
	}
	
	public List<BpAccountAcct> findByVendorPrepayAccountId(Long vendorPrepayAccountId) {
		return (List<BpAccountAcct>) this.em
			.createQuery("select e from BpAccountAcct e where e.clientId = :pClientId and e.vendorPrepayAccount.id = :pVendorPrepayAccountId", BpAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
