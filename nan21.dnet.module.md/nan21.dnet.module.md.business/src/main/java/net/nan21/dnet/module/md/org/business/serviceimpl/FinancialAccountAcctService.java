...
public class FinancialAccountAcctService extends AbstractEntityService<FinancialAccountAcct>
	...
	public FinancialAccountAcct findByAccount_schema(FinancialAccount financialAccount,AccSchema accSchema) {		 
		return (FinancialAccountAcct) this.em
			.createNamedQuery(FinancialAccountAcct.NQ_FIND_BY_ACCOUNT_SCHEMA)
	...
	public FinancialAccountAcct findByAccount_schema( Long financialAccountId, Long accSchemaId) {
		return (FinancialAccountAcct) this.em
			.createNamedQuery(FinancialAccountAcct.NQ_FIND_BY_ACCOUNT_SCHEMA_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<FinancialAccountAcct> findByFinancialAccountId(Long financialAccountId) {
		return (List<FinancialAccountAcct>) this.em
			.createQuery("select e from FinancialAccountAcct e where e.clientId = :pClientId and e.financialAccount.id = :pFinancialAccountId", FinancialAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pFinancialAccountId", financialAccountId)			 	
			.getResultList(); 
	}
	...
	public List<FinancialAccountAcct> findByAccSchemaId(Long accSchemaId) {
		return (List<FinancialAccountAcct>) this.em
			.createQuery("select e from FinancialAccountAcct e where e.clientId = :pClientId and e.accSchema.id = :pAccSchemaId", FinancialAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAccSchemaId", accSchemaId)			 	
			.getResultList(); 
	}
	
	public List<FinancialAccountAcct> findByDepositAccount(Account depositAccount) {
		return this.findByDepositAccountId(depositAccount.getId()); 
	}
	
	public List<FinancialAccountAcct> findByDepositAccountId(Long depositAccountId) {
		return (List<FinancialAccountAcct>) this.em
			.createQuery("select e from FinancialAccountAcct e where e.clientId = :pClientId and e.depositAccount.id = :pDepositAccountId", FinancialAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pDepositAccountId", depositAccountId)			 	
			.getResultList(); 
	}
	
	public List<FinancialAccountAcct> findByWithdrawalAccount(Account withdrawalAccount) {
		return this.findByWithdrawalAccountId(withdrawalAccount.getId()); 
	}
	
	public List<FinancialAccountAcct> findByWithdrawalAccountId(Long withdrawalAccountId) {
		return (List<FinancialAccountAcct>) this.em
			.createQuery("select e from FinancialAccountAcct e where e.clientId = :pClientId and e.withdrawalAccount.id = :pWithdrawalAccountId", FinancialAccountAcct.class)
			.setParameter("pClientId", Session.user.get().getClientId())
