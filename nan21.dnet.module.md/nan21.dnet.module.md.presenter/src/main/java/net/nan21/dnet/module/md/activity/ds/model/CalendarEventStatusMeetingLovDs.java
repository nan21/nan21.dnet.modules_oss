...
@Ds(entity = CalendarEventStatus.class, jpqlWhere = "  e.eventType = 'meeting' ", sort = {@SortField(field = CalendarEventStatusMeetingLovDs.f_name)})
public class CalendarEventStatusMeetingLovDs
		extends
