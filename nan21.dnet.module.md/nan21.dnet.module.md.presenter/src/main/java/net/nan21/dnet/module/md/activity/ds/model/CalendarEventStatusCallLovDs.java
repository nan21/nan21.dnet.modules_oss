...
@Ds(entity = CalendarEventStatus.class, jpqlWhere = "  e.eventType = 'call'  ", sort = {@SortField(field = CalendarEventStatusCallLovDs.f_name)})
public class CalendarEventStatusCallLovDs
		extends
