...
@Ds(entity = InvTransaction.class, sort = {@SortField(field = InvTransactionDs.f_eventDate, desc = true)})
@RefLookups({
		@RefLookup(refId = InvTransactionDs.f_transactionTypeId, namedQuery = InvTransactionType.NQ_FIND_BY_NAME, params = {@Param(name = "pName", field = InvTransactionDs.f_transactionType)}),
		@RefLookup(refId = InvTransactionDs.f_fromInventoryId, namedQuery = Organization.NQ_FIND_BY_NAME, params = {@Param(name = "pName", field = InvTransactionDs.f_fromInventory)}),
		@RefLookup(refId = InvTransactionDs.f_toInventoryId, namedQuery = Organization.NQ_FIND_BY_NAME, params = {@Param(name = "pName", field = InvTransactionDs.f_toInventory)})})
