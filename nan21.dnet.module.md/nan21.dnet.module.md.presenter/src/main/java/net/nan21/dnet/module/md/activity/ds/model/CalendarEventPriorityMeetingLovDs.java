...
@Ds(entity = CalendarEventPriority.class, jpqlWhere = "  e.eventType = 'meeting' ", sort = {@SortField(field = CalendarEventPriorityMeetingLovDs.f_name)})
public class CalendarEventPriorityMeetingLovDs
		extends
