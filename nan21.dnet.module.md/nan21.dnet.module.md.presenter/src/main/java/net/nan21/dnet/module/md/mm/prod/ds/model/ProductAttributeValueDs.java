...
@DsQueryHints({
@QueryHint(name=QueryHints.LEFT_FETCH, value="e.product.attributeSet")
})
public class ProductAttributeValueDs extends AbstractAuditableDs<ProductAttributeValue> {
