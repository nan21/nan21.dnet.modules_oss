...
import net.nan21.dnet.module.md.acc.ds.model.AccountDs;

public class AccountDsConv extends AbstractDsConverter<AccountDs, Account> 
		implements IDsConverter<AccountDs, Account> {
    
    @Override
    protected void modelToEntityReferences(AccountDs ds, Account e, boolean isInsert) throws Exception {
    ...
    protected void lookup_accSchema_AccSchema(AccountDs ds, Account e ) throws Exception {
