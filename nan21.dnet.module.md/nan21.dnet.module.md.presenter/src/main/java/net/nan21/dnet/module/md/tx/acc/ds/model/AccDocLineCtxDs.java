...
@Ds(entity=AccDocLine.class, sort={@SortField(field=AccDocLineCtxDs.fACCSCHEMAID), @SortField(field=AccDocLineCtxDs.fACCDOCID), @SortField(field=AccDocLineCtxDs.fSEQUENCENO)})
