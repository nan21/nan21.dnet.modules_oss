...
public class InvTransactionTypeDsConv extends AbstractDsConverter<InvTransactionTypeDs, InvTransactionType> 
		implements IDsConverter<InvTransactionTypeDs, InvTransactionType> {
    
    @Override
    protected void modelToEntityReferences(InvTransactionTypeDs ds, InvTransactionType e, boolean isInsert) throws Exception {
    ...
    protected void lookup_docType_TxDocType(InvTransactionTypeDs ds, InvTransactionType e ) throws Exception {
