...
public class MyCalendarCallDsConv
		extends
			AbstractDsConverter<MyCalendarCallDs, CalendarEvent>
		implements
			IDsConverter<MyCalendarCallDs, CalendarEvent> {

	@Override
	protected void modelToEntityReferences(MyCalendarCallDs ds,
