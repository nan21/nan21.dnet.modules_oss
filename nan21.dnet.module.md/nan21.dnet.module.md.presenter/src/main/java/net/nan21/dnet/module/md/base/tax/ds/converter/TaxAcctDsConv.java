...
import net.nan21.dnet.module.md.base.tax.ds.model.TaxAcctDs;

public class TaxAcctDsConv extends AbstractDsConverter<TaxAcctDs, TaxAcct> 
		implements IDsConverter<TaxAcctDs, TaxAcct> {
    
    @Override
    protected void modelToEntityReferences(TaxAcctDs ds, TaxAcct e, boolean isInsert) throws Exception {
    	if( ds.getTaxId() != null  ) {
    ...
    protected void lookup_accSchema_AccSchema(TaxAcctDs ds, TaxAcct e ) throws Exception {
    ...
    protected void lookup_salesAccount_Account(TaxAcctDs ds, TaxAcct e ) throws Exception {
    ...
    protected void lookup_purchaseAccount_Account(TaxAcctDs ds, TaxAcct e ) throws Exception {
