...
public class FinancialAccountAcctDsConv extends AbstractDsConverter<FinancialAccountAcctDs, FinancialAccountAcct> 
		implements IDsConverter<FinancialAccountAcctDs, FinancialAccountAcct> {
    
    @Override
    protected void modelToEntityReferences(FinancialAccountAcctDs ds, FinancialAccountAcct e, boolean isInsert) throws Exception {
    	if( ds.getFinancialAccountId() != null  ) {
    		if (e.getFinancialAccount() == null || !e.getFinancialAccount().getId().equals(ds.getFinancialAccountId()) ) {
    			e.setFinancialAccount( (FinancialAccount) this.em.find(FinancialAccount.class, ds.getFinancialAccountId() ) );
    		}
    	}
    	else {
    	...
    	if( ds.getDepositAccountId() != null  ) {
    		if (e.getDepositAccount() == null || !e.getDepositAccount().getId().equals(ds.getDepositAccountId()) ) {
    	...
    	if( ds.getWithdrawalAccountId() != null  ) {
    		if (e.getWithdrawalAccount() == null || !e.getWithdrawalAccount().getId().equals(ds.getWithdrawalAccountId()) ) {
    ...
    protected void lookup_financialAccount_FinancialAccount(FinancialAccountAcctDs ds, FinancialAccountAcct e ) throws Exception {
    	if (ds.getFinancialAccount() != null && !ds.getFinancialAccount().equals("") ) {
    		FinancialAccount x = null;
    		try { 
    			x = ((IFinancialAccountService)findEntityService(FinancialAccount.class)).findByName( ds.getFinancialAccount() );
    		} catch(javax.persistence.NoResultException exception) {
    			throw new Exception("Invalid value provided to find `FinancialAccount` reference: `financialAccount` = " + ds.getFinancialAccount() + "" );
    		}
    ...
    protected void lookup_accSchema_AccSchema(FinancialAccountAcctDs ds, FinancialAccountAcct e ) throws Exception {
    ...
    protected void lookup_depositAccount_Account(FinancialAccountAcctDs ds, FinancialAccountAcct e ) throws Exception {
    	if (ds.getDepositAccount() != null && !ds.getDepositAccount().equals("") ) {
    		...
    		try { 
    			...
    			throw new Exception("Invalid value provided to find `Account` reference: `depositAccount` = " + ds.getDepositAccount() + "" );
    		}
    ...
    protected void lookup_withdrawalAccount_Account(FinancialAccountAcctDs ds, FinancialAccountAcct e ) throws Exception {
    	if (ds.getWithdrawalAccount() != null && !ds.getWithdrawalAccount().equals("") ) {
    		Account x = null;
    		try { 
    			x = ((IAccountService)findEntityService(Account.class)).findByCode( ds.getWithdrawalAccount() );
    		} catch(javax.persistence.NoResultException exception) {
    			throw new Exception("Invalid value provided to find `Account` reference: `withdrawalAccount` = " + ds.getWithdrawalAccount() + "" );
    		}
