Ext.define("net.nan21.dnet.module.md.base.tx.lovs.TxDocTypesSO", {
	extend: "dnet.core.lov.AbstractCombo",
	alias: "widget.md_base_tx_lovs_TxDocTypesSO",
	...
	recordModel: "net.nan21.dnet.module.md.base.tx.ds.model.TxDocTypeSOLovDs",
