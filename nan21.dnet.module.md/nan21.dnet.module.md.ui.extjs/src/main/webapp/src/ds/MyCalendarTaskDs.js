 ...
 */
Ext.define("net.nan21.dnet.module.md.activity.ds.model.MyCalendarTaskDs" ,{
...
Ext.define("net.nan21.dnet.module.md.activity.ds.model.MyCalendarTaskDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [
...
Ext.define("net.nan21.dnet.module.md.activity.ds.param.MyCalendarTaskDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
});
