 ...
 */
Ext.define("net.nan21.dnet.module.md.tx.inventory.ds.model.InvTransactionDs" ,{
...
Ext.define("net.nan21.dnet.module.md.tx.inventory.ds.model.InvTransactionDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [
		{name:"code", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.tx.inventory.ds.param.InvTransactionDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
});
