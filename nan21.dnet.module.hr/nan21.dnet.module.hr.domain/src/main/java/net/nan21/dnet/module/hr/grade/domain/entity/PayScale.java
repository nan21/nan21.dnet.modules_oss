...
@Entity
@Table(name = PayScale.TABLE_NAME, uniqueConstraints = {
		@UniqueConstraint(name = PayScale.TABLE_NAME + "_UK1", columnNames = {
				"CLIENTID", "CODE"}),
		@UniqueConstraint(name = PayScale.TABLE_NAME + "_UK2", columnNames = {
				"CLIENTID", "NAME"})})
