...
@Ds(entity = EmployeeContactRelationship.class, jpqlWhere = " e.active = true ", sort = {@SortField(field = EmployeeContactRelationshipLovDs.f_name)})
public class EmployeeContactRelationshipLovDs
		extends
