...
public class PayrollDsConv extends AbstractDsConverter<PayrollDs, Payroll> 
    ...
    @Override
    protected void modelToEntityReferences(PayrollDs ds, Payroll e, boolean isInsert) throws Exception {
    ...
    protected void lookup_engine_Engine(PayrollDs ds, Payroll e ) throws Exception {
