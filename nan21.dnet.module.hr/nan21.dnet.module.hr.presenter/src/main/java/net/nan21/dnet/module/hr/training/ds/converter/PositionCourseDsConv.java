...
public class PositionCourseDsConv extends AbstractDsConverter<PositionCourseDs, PositionCourse> 
		implements IDsConverter<PositionCourseDs, PositionCourse> {
    
    @Override
    protected void modelToEntityReferences(PositionCourseDs ds, PositionCourse e, boolean isInsert) throws Exception {
    ...
    protected void lookup_position_Position(PositionCourseDs ds, PositionCourse e ) throws Exception {
    ...
    protected void lookup_course_Course(PositionCourseDs ds, PositionCourse e ) throws Exception {
