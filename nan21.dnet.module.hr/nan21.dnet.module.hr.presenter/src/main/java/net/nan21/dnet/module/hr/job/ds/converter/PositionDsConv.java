...
public class PositionDsConv extends AbstractDsConverter<PositionDs, Position> 
    ...
    @Override
    protected void modelToEntityReferences(PositionDs ds, Position e, boolean isInsert) throws Exception {
    	if( ds.getOrgId() != null  ) {
    ...
    protected void lookup_org_Organization(PositionDs ds, Position e ) throws Exception {
