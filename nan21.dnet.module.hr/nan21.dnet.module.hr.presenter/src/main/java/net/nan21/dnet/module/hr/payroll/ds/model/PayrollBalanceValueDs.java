...
@Ds(entity=PayrollElementValue.class,jpqlWhere=" e.element.balance = true ", sort={@SortField(field=PayrollBalanceValueDs.fPERIODSTART,desc=true), @SortField(field=PayrollBalanceValueDs.fSEQUENCENO), @SortField(field=PayrollBalanceValueDs.fEMPLOYERID)})
public class PayrollBalanceValueDs extends AbstractAuditableDs<PayrollElementValue> {
