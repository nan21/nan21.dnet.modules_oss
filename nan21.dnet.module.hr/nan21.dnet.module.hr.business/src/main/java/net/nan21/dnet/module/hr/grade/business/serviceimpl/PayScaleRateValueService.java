...
public class PayScaleRateValueService extends AbstractEntityService<PayScaleRateValue>
		implements IPayScaleRateValueService {
	...
	public List<PayScaleRateValue> findByScaleRateId(Long scaleRateId) {
		return (List<PayScaleRateValue>) this.em
			.createQuery("select e from PayScaleRateValue e where e.clientId = :pClientId and e.scaleRate.id = :pScaleRateId", PayScaleRateValue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pScaleRateId", scaleRateId)			 	
			.getResultList(); 
	}
	...
	public List<PayScaleRateValue> findByScalePointId(Long scalePointId) {
		return (List<PayScaleRateValue>) this.em
			.createQuery("select e from PayScaleRateValue e where e.clientId = :pClientId and e.scalePoint.id = :pScalePointId", PayScaleRateValue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pScalePointId", scalePointId)			 	
			.getResultList(); 
	}
}
