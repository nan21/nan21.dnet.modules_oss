...
public class EmployeeSkillService extends AbstractEntityService<EmployeeSkill>
	...
	public List<EmployeeSkill> findByEmployeeId(Long employeeId) {
		return (List<EmployeeSkill>) this.em
			.createQuery("select e from EmployeeSkill e where e.clientId = :pClientId and e.employee.id = :pEmployeeId", EmployeeSkill.class)
	...
	public List<EmployeeSkill> findBySkillId(Long skillId) {
		return (List<EmployeeSkill>) this.em
			.createQuery("select e from EmployeeSkill e where e.clientId = :pClientId and e.skill.id = :pSkillId", EmployeeSkill.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeSkill> findBySkillLevelId(Long skillLevelId) {
		return (List<EmployeeSkill>) this.em
			.createQuery("select e from EmployeeSkill e where e.clientId = :pClientId and e.skillLevel.id = :pSkillLevelId", EmployeeSkill.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pSkillLevelId", skillLevelId)			 	
			.getResultList(); 
	}
}
