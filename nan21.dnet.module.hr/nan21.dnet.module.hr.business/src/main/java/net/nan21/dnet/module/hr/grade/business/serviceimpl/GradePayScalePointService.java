...
public class GradePayScalePointService extends AbstractEntityService<GradePayScalePoint>
		implements IGradePayScalePointService {
	...
	public List<GradePayScalePoint> findByGradePayScaleId(Long gradePayScaleId) {
		return (List<GradePayScalePoint>) this.em
			.createQuery("select e from GradePayScalePoint e where e.clientId = :pClientId and e.gradePayScale.id = :pGradePayScaleId", GradePayScalePoint.class)
	...
	public List<GradePayScalePoint> findByPointId(Long pointId) {
		return (List<GradePayScalePoint>) this.em
			.createQuery("select e from GradePayScalePoint e where e.clientId = :pClientId and e.point.id = :pPointId", GradePayScalePoint.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pPointId", pointId)			 	
			.getResultList(); 
	}
}
