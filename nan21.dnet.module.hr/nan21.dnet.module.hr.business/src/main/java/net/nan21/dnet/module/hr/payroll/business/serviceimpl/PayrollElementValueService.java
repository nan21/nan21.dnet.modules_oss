...
public class PayrollElementValueService extends AbstractEntityService<PayrollElementValue>
		implements IPayrollElementValueService {
	...
	public List<PayrollElementValue> findByElementId(Long elementId) {
		return (List<PayrollElementValue>) this.em
			.createQuery("select e from PayrollElementValue e where e.clientId = :pClientId and e.element.id = :pElementId", PayrollElementValue.class)
	...
	public List<PayrollElementValue> findByPeriodId(Long periodId) {
		return (List<PayrollElementValue>) this.em
			.createQuery("select e from PayrollElementValue e where e.clientId = :pClientId and e.period.id = :pPeriodId", PayrollElementValue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pPeriodId", periodId)			 	
			.getResultList(); 
	}
	
	public List<PayrollElementValue> findByAssignment(EmployeeAssignment assignment) {
		return this.findByAssignmentId(assignment.getId()); 
	}
	
	public List<PayrollElementValue> findByAssignmentId(Long assignmentId) {
		return (List<PayrollElementValue>) this.em
			.createQuery("select e from PayrollElementValue e where e.clientId = :pClientId and e.assignment.id = :pAssignmentId", PayrollElementValue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAssignmentId", assignmentId)			 	
			.getResultList(); 
	}
	...
	public List<PayrollElementValue> findByOrgId(Long orgId) {
		return (List<PayrollElementValue>) this.em
			.createQuery("select e from PayrollElementValue e where e.clientId = :pClientId and e.org.id = :pOrgId", PayrollElementValue.class)
			.setParameter("pClientId", Session.user.get().getClientId())
