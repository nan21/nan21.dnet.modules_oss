...
public class EmployeeAssignmentService extends AbstractEntityService<EmployeeAssignment>
		implements IEmployeeAssignmentService {
	...
	public List<EmployeeAssignment> findByEmployeeId(Long employeeId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.employee.id = :pEmployeeId", EmployeeAssignment.class)
	...
	public List<EmployeeAssignment> findByTypeId(Long typeId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.type.id = :pTypeId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeAssignment> findByPositionId(Long positionId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.position.id = :pPositionId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeAssignment> findByJobId(Long jobId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.job.id = :pJobId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeAssignment> findByOrgId(Long orgId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.org.id = :pOrgId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeAssignment> findByGradeId(Long gradeId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.grade.id = :pGradeId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<EmployeeAssignment> findByPayrollId(Long payrollId) {
		return (List<EmployeeAssignment>) this.em
			.createQuery("select e from EmployeeAssignment e where e.clientId = :pClientId and e.payroll.id = :pPayrollId", EmployeeAssignment.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pPayrollId", payrollId)			 	
			.getResultList(); 
	}
}
