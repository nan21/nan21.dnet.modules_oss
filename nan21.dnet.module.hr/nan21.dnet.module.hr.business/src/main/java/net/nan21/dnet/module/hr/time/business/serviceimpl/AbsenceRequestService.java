...
public class AbsenceRequestService extends AbstractEntityService<AbsenceRequest>
		implements IAbsenceRequestService {
	...
	public List<AbsenceRequest> findByEmployeeId(Long employeeId) {
		return (List<AbsenceRequest>) this.em
			.createQuery("select e from AbsenceRequest e where e.clientId = :pClientId and e.employee.id = :pEmployeeId", AbsenceRequest.class)
	...
	public List<AbsenceRequest> findByTypeId(Long typeId) {
		return (List<AbsenceRequest>) this.em
			.createQuery("select e from AbsenceRequest e where e.clientId = :pClientId and e.type.id = :pTypeId", AbsenceRequest.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AbsenceRequest> findByReasonId(Long reasonId) {
		return (List<AbsenceRequest>) this.em
			.createQuery("select e from AbsenceRequest e where e.clientId = :pClientId and e.reason.id = :pReasonId", AbsenceRequest.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AbsenceRequest> findByItemsId(Long itemsId) {
		return (List<AbsenceRequest>) this.em
			.createQuery("select distinct e from AbsenceRequest e, IN (e.items) c where e.clientId = :pClientId and c.id = :pItemsId", AbsenceRequest.class)
			.setParameter("pClientId", Session.user.get().getClientId())
