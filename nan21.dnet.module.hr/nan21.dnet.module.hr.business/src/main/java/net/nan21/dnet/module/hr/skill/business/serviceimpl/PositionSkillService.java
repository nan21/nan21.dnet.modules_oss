...
public class PositionSkillService extends AbstractEntityService<PositionSkill>
	...
	public List<PositionSkill> findByPositionId(Long positionId) {
		return (List<PositionSkill>) this.em
			.createQuery("select e from PositionSkill e where e.clientId = :pClientId and e.position.id = :pPositionId", PositionSkill.class)
	...
	public List<PositionSkill> findBySkillId(Long skillId) {
		return (List<PositionSkill>) this.em
			.createQuery("select e from PositionSkill e where e.clientId = :pClientId and e.skill.id = :pSkillId", PositionSkill.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<PositionSkill> findByRequiredLevelId(Long requiredLevelId) {
		return (List<PositionSkill>) this.em
			.createQuery("select e from PositionSkill e where e.clientId = :pClientId and e.requiredLevel.id = :pRequiredLevelId", PositionSkill.class)
			.setParameter("pClientId", Session.user.get().getClientId())
