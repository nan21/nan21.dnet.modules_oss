...
public class OrganizationHierarchyItemService extends AbstractEntityService<OrganizationHierarchyItem>
		implements IOrganizationHierarchyItemService {
	...
	public List<OrganizationHierarchyItem> findByHierarchy(OrganizationHierarchy hierarchy) {
	...
	public List<OrganizationHierarchyItem> findByHierarchyId(Long hierarchyId) {
		return (List<OrganizationHierarchyItem>) this.em
			.createQuery("select e from OrganizationHierarchyItem e where e.clientId = :pClientId and e.hierarchy.id = :pHierarchyId", OrganizationHierarchyItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pHierarchyId", hierarchyId)			 	
			.getResultList(); 
	}
	...
	public List<OrganizationHierarchyItem> findByOrgId(Long orgId) {
		return (List<OrganizationHierarchyItem>) this.em
			.createQuery("select e from OrganizationHierarchyItem e where e.clientId = :pClientId and e.org.id = :pOrgId", OrganizationHierarchyItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<OrganizationHierarchyItem> findByParentId(Long parentId) {
		return (List<OrganizationHierarchyItem>) this.em
			.createQuery("select e from OrganizationHierarchyItem e where e.clientId = :pClientId and e.parent.id = :pParentId", OrganizationHierarchyItem.class)
			.setParameter("pClientId", Session.user.get().getClientId())
