...
public class AttributeSetAttributeService extends AbstractEntityService<AttributeSetAttribute>
		implements IAttributeSetAttributeService {
	...
	public AttributeSetAttribute findByName( Long attributeSetId, Long attributeId) {
		return (AttributeSetAttribute) this.em
			.createNamedQuery(AttributeSetAttribute.NQ_FIND_BY_NAME_PRIMITIVE)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<AttributeSetAttribute> findByAttributeSetId(Long attributeSetId) {
		return (List<AttributeSetAttribute>) this.em
			.createQuery("select e from AttributeSetAttribute e where e.clientId = :pClientId and e.attributeSet.id = :pAttributeSetId", AttributeSetAttribute.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAttributeSetId", attributeSetId)			 	
			.getResultList(); 
	}
	...
	public List<AttributeSetAttribute> findByAttributeId(Long attributeId) {
		return (List<AttributeSetAttribute>) this.em
			.createQuery("select e from AttributeSetAttribute e where e.clientId = :pClientId and e.attribute.id = :pAttributeId", AttributeSetAttribute.class)
			.setParameter("pClientId", Session.user.get().getClientId())
			.setParameter("pAttributeId", attributeId)			 	
			.getResultList(); 
	}
