...
public class CurrencyXRateAverageService extends AbstractEntityService<CurrencyXRateAverage>
		implements ICurrencyXRateAverageService {
	...
	public List<CurrencyXRateAverage> findByProviderId(Long providerId) {
		return (List<CurrencyXRateAverage>) this.em
			.createQuery("select e from CurrencyXRateAverage e where e.clientId = :pClientId and e.provider.id = :pProviderId", CurrencyXRateAverage.class)
	...
	public List<CurrencyXRateAverage> findBySourceId(Long sourceId) {
		return (List<CurrencyXRateAverage>) this.em
			.createQuery("select e from CurrencyXRateAverage e where e.clientId = :pClientId and e.source.id = :pSourceId", CurrencyXRateAverage.class)
			.setParameter("pClientId", Session.user.get().getClientId())
	...
	public List<CurrencyXRateAverage> findByTargetId(Long targetId) {
		return (List<CurrencyXRateAverage>) this.em
			.createQuery("select e from CurrencyXRateAverage e where e.clientId = :pClientId and e.target.id = :pTargetId", CurrencyXRateAverage.class)
			.setParameter("pClientId", Session.user.get().getClientId())
