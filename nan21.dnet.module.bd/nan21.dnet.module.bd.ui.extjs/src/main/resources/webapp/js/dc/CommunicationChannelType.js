...
Ext.define("net.nan21.dnet.module.bd.contact.dc.CommunicationChannelType$Filter", {
	...
	alias: "widget.bd_contact_dc_CommunicationChannelType$Filter",
	...
	_defineElements_: function() {
		this._getBuilder_()
			...
			.addCombo({ xtype:"combo", name:"type", _sharedLabel_:true, dataIndex:"type", anchor:"-20",
				store:[ "email", "messenger", "phone", "url", "other"]
			})
...
Ext.define("net.nan21.dnet.module.bd.contact.dc.CommunicationChannelType$EditList", {
	...
	alias: "widget.bd_contact_dc_CommunicationChannelType$EditList",
