...
@Ds(entity = CurrencyXRateProvider.class, jpqlWhere = " e.active = true ", sort = {@SortField(field = CurrencyXRateProviderLovDs.f_code)})
public class CurrencyXRateProviderLovDs
		extends
