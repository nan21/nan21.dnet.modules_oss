...
public class ElementCategoryDsConv extends AbstractDsConverter<ElementCategoryDs, ElementCategory> 
		implements IDsConverter<ElementCategoryDs, ElementCategory> {
    
    @Override
    protected void modelToEntityReferences(ElementCategoryDs ds, ElementCategory e, boolean isInsert) throws Exception {
    ...
    protected void lookup_engine_Engine(ElementCategoryDs ds, ElementCategory e ) throws Exception {
