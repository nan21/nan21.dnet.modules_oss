...
@Ds(entity=CurrencyXRate.class, sort={@SortField(field=CurrencyXRateDs.fVALIDAT,desc=true), @SortField(field=CurrencyXRateDs.fSOURCECODE), @SortField(field=CurrencyXRateDs.fTARGETCODE)})
