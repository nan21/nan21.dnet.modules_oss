...
@Ds(entity=ElementInput.class, sort={@SortField(field=ElementInputDs.fENGINE), @SortField(field=ElementInputDs.fSEQUENCENO), @SortField(field=ElementInputDs.fREFERENCE)})
