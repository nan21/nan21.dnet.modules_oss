...
public class CityDsConv extends AbstractDsConverter<CityDs, City> 
		implements IDsConverter<CityDs, City> {
    
    @Override
    protected void modelToEntityReferences(CityDs ds, City e, boolean isInsert) throws Exception {
